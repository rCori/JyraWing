...
public class EnemySpawnMinBossPlusExtras : EnemySpawner {
	...
	public override void Spawn ()
	{
		...
		if (turrets) {
			...
			enemy2.GetComponent<EnemyAI10> ().fireDirection = EnemyAI10.FireDirection.LEFT;
			enemy2 = Instantiate (enemy2);



			GameObject enemy3 = (GameObject) Resources.Load ("Enemies/Enemy_J");
			...
			enemy3.GetComponent<EnemyAI10> ().Health = 3;
			enemy3.GetComponent<EnemyAI10> ().fireDirection = EnemyAI10.FireDirection.LEFT;
